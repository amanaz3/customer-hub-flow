...
const Analysis = () => {
  ...
  const featuredCard = {
    title: "360° AI View",
    description: "Get comprehensive AI-powered insights across RFM Model and Service Analytics - your analytics command center",
    icon: Activity,
    path: "/360-degree",
    color: "text-primary"
  };
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card
        className="cursor-pointer hover:shadow-xl transition-all hover:border-primary/50 animate-fade-in border-2 border-primary/20 bg-gradient-to-r from-primary/5 via-purple-500/5 to-amber-500/5"
