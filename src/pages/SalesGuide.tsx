...
const SalesGuide = () => {
  ...
  const [quickRefTab, setQuickRefTab] = useState("stages");
    ...
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      ...
      <Tabs defaultValue="level-1" className="w-full">
        <TabsList className="flex flex-wrap gap-1 h-auto mb-6 p-2 bg-muted/50">
          ...
          <TabsTrigger value="quick-ref" className="text-xs px-3 py-2 gap-1.5 bg-primary/10 border border-primary/20">
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Fast lookup for sales frameworks, techniques & scripts</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Tabs value={quickRefTab} onValueChange={setQuickRefTab} className="w-full">
                ...
                <TabsContent value="assessment" className="space-y-4">
                  ...
                  <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                    <h4 className="font-semibold mb-2 text-blue-600">Urgency Indicators</h4>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div className="p-2 rounded bg-green-500/10">
                        <p className="font-medium text-green-600">🟢 High Urgency</p>
                        <ul className="text-xs text-muted-foreground mt-1">
                          <li>• Deadline mentioned</li>
                          <li>• Pain actively affecting business</li>
                          <li>• Budget allocated</li>
                          <li>• Decision maker on call</li>
                        </ul>
                      </div>
                      <div className="p-2 rounded bg-amber-500/10">
                        <p className="font-medium text-amber-600">🟡 Low Urgency</p>
                        <ul className="text-xs text-muted-foreground mt-1">
                          <li>• "Just researching"</li>
                          <li>• No timeline mentioned</li>
                          <li>• Need to check with others</li>
                          <li>• Vague pain description</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-lg bg-background/50 border">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      <div className="p-3 rounded bg-red-500/10 border border-red-500/20">
                        ...
                        <p className="text-xs italic mt-1">"Here's the bottom line..."</p>
                      </div>
                      <div className="p-3 rounded bg-yellow-500/10 border border-yellow-500/20">
                        ...
                        <p className="text-xs italic mt-1">"Imagine how this would feel..."</p>
                      </div>
                      <div className="p-3 rounded bg-green-500/10 border border-green-500/20">
                        ...
                        <p className="text-xs italic mt-1">"Take your time, we're here to support..."</p>
                      </div>
                      <div className="p-3 rounded bg-blue-500/10 border border-blue-500/20">
                        ...
                        <p className="text-xs italic mt-1">"Let me share the specifics..."</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
                    <h4 className="font-semibold mb-2 text-purple-600">Quick Personality Detection</h4>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• <strong>First 30 seconds:</strong> Listen to pace, tone, and what they mention first</li>
                      <li>• <strong>D types:</strong> Often mention time constraints or wanting quick answers</li>
                      <li>• <strong>I types:</strong> May share personal context or make small talk</li>
                      <li>• <strong>S types:</strong> Ask about how things work and mention their team</li>
                      <li>• <strong>C types:</strong> Ask detailed questions and want specifics upfront</li>
                    </ul>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="objections" className="space-y-4">
                  <div className="p-4 rounded-lg bg-background/50 border">
                    ...
                    <div className="space-y-2">
                      {[
                        { letter: "L", title: "Listen", desc: "Let them finish completely. Don't interrupt or prepare your response." },
                        { letter: "A", title: "Acknowledge", desc: "Show you heard them. \"I understand...\" or \"That's a fair concern...\"" },
                        { letter: "E", title: "Explore", desc: "Dig deeper. \"Help me understand - is it the price itself or the value?\"" },
                        { letter: "R", title: "Respond", desc: "Address the real concern with relevant information or stories." }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/50 flex items-start gap-3">
                          <span className="w-8 h-8 rounded-full bg-amber-500 text-white flex items-center justify-center font-bold shrink-0">{item.letter}</span>
                          <div>
                  ...
                  <div className="p-4 rounded-lg bg-background/50 border">
                    <h4 className="font-semibold mb-3">Common Objections & Responses</h4>
                    <div className="space-y-3">
                      {[
                        { objection: "It's too expensive", response: "I understand price is important. Can I ask - compared to what? Let me show you the ROI breakdown..." },
                        { objection: "I need to think about it", response: "Of course. What specifically would you be thinking about - the price, timing, or something about the service?" },
                        { objection: "Send me information", response: "Happy to! To send you the most relevant info, can I ask - what would you be looking for specifically?" },
                        { objection: "I'm happy with current provider", response: "That's great you have something working. Out of curiosity, is there anything you wish was different?" },
                        { objection: "Not the right time", response: "I understand timing is important. When would be a better time, and what would need to change?" }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/30">
                          <p className="text-sm font-medium text-red-500 mb-1">❌ "{item.objection}"</p>
                ...
                <TabsContent value="closing" className="space-y-4">
                  <div className="p-4 rounded-lg bg-background/50 border">
                    ...
                    <div className="space-y-3">
                      {[
                        { name: "Assumptive Close", desc: "Act as if they've decided. \"So shall I set you up with the standard or premium package?\"" },
                        { name: "Summary Close", desc: "Recap value then ask. \"So you get X, Y, and Z - shall we proceed?\"" },
                        { name: "Urgency Close", desc: "Create time pressure. \"This rate is only available until Friday.\"" },
                        { name: "Alternative Close", desc: "Give two options. \"Would you prefer to start this month or next?\"" },
                        { name: "Direct Close", desc: "Simply ask. \"Are you ready to move forward?\"" },
                        { name: "Trial Close", desc: "Test readiness. \"How does that sound so far?\"" }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/50 border-l-4 border-purple-500/50">
                  ...
                  <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                    <h4 className="font-semibold mb-2 text-green-600">Buying Signals to Watch</h4>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div>
                        <p className="font-medium text-xs mb-1">Verbal Signals</p>
                        <ul className="text-xs text-muted-foreground space-y-1">
                      ...
                      <div>
                        <p className="font-medium text-xs mb-1">Behavioral Signals</p>
                        <ul className="text-xs text-muted-foreground space-y-1">
                          <li>• Asking detailed questions</li>
                          <li>• Discussing implementation</li>
                          <li>• Mentioning their team</li>
                ...
                <TabsContent value="prep" className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="p-4 rounded-lg bg-background/50 border">
                      ...
                      <div className="space-y-2">
                        {[
                          "Review client info/history in CRM",
                          "Prepare 3 personalized opening hooks",
                          "List 5 discovery questions",
                          "Know pricing options & discounts",
                          "Prepare for top 3 likely objections",
                    ...
                    <div className="p-4 rounded-lg bg-background/50 border">
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          "Send promised materials within 1 hour",
                          "Schedule follow-up task",
                          "Rate the call (1-10) and reflect",
                          "Note what worked / what to improve",
                          "If closed: send welcome email",
                          "If not closed: plan next touch"
                        ].map((item, i) => (
                          <div key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                            <div className="w-4 h-4 rounded border border-muted-foreground/30 shrink-0" />
                            {item}
                  ...
                  <div className="p-4 rounded-lg bg-background/50 border">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 rounded bg-muted/30">
                        <p className="font-medium text-sm mb-1">Follow-up After Call (No Decision)</p>
                        <p className="text-xs text-muted-foreground whitespace-pre-line">
                          Subject: Great speaking with you, [Name]
                          
                          Hi [Name],
                          
                          Thank you for taking the time to discuss [topic]. As promised, I've attached [materials].
                          
                          To recap, you mentioned [pain point] and we discussed how [solution] could help by [benefit].
                          
                          I'll follow up [day] to answer any questions. In the meantime, feel free to reach out.
                          
                          Best regards
                        </p>
                      </div>
                      <div className="p-3 rounded bg-muted/30">
                        <p className="font-medium text-sm mb-1">Welcome Email (After Close)</p>
                        <p className="text-xs text-muted-foreground whitespace-pre-line">
                          ...
                          Your dedicated contact is [name/email]. We're here to ensure your success.
                ...
                <TabsContent value="faqs" className="space-y-4">
                  <Tabs defaultValue="outbound" className="w-full">
                    <TabsList className="h-auto p-1 bg-muted/30">
                      ...
                      <TabsTrigger value="postsale" className="text-xs">Post-Sale Support</TabsTrigger>
                    </TabsList>
                    <TabsContent value="outbound" className="mt-4 space-y-3">
                      {[
                        { q: "How do I get past gatekeepers?", a: "Be confident and specific. \"Hi, I'm calling regarding [specific topic] for [Name]. Is now a good time to connect me?\"" },
                        { q: "What if they say they're not interested?", a: "\"I understand. Out of curiosity, is it the timing or does [problem] just not resonate?\" Often reveals the real concern." },
                        { q: "How many times should I follow up?", a: "Research shows 5-7 touches. Vary channels: call, email, LinkedIn. Space 2-3 days apart." },
                        { q: "Best time to cold call?", a: "Tuesday-Thursday, 10-11am or 2-4pm typically work best. Avoid Mondays and Fridays." }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/30">
                          <p className="font-medium text-sm text-primary mb-1">Q: {item.q}</p>
                    ...
                    <TabsContent value="inbound" className="mt-4 space-y-3">
                      {[
                        { q: "Client asks for price immediately?", a: "\"Great question! Pricing depends on your specific needs. To give you an accurate quote, can I ask a couple of quick questions?\"" },
                        { q: "How to handle comparison shoppers?", a: "\"Smart to compare options! What criteria are most important to you?\" Then position your strengths accordingly." },
                        { q: "What if they found us through a bad review?", a: "Acknowledge it honestly. \"Thank you for mentioning that. Here's what happened and how we've improved...\"" },
                        { q: "Client seems ready but won't commit?", a: "\"You seem interested but something's holding you back. Can you help me understand what that is?\"" }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/30">
                          <p className="font-medium text-sm text-primary mb-1">Q: {item.q}</p>
                          <p className="text-xs text-muted-foreground">A: {item.a}</p>
                    ...
                    <TabsContent value="followup" className="mt-4 space-y-3">
                      {[
                        { q: "They don't respond to emails?", a: "Try different channels. A brief voice message or LinkedIn message can break through when email fails." },
                        { q: "How long to wait before following up?", a: "After initial call: 24-48 hours. After proposal: 2-3 days. After that: weekly until they respond or opt out." },
                        { q: "What to say when they've gone quiet?", a: "\"Hi [Name], I know you're busy. Should I close this file or would a brief catch-up next week work better?\"" },
                        { q: "They said 'next quarter' - now what?", a: "Set a calendar reminder. Touch base 2 weeks before their mentioned timeline with relevant value-add." }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/30">
                          <p className="font-medium text-sm text-primary mb-1">Q: {item.q}</p>
                          <p className="text-xs text-muted-foreground">A: {item.a}</p>
                    ...
                    <TabsContent value="postsale" className="mt-4 space-y-3">
                      {[
                        { q: "Client complains after purchase?", a: "Listen fully, apologize for the experience, and fix it fast. \"I'm sorry this happened. Here's how I'll make it right...\"" },
                        { q: "How to ask for referrals?", a: "After delivering value: \"I'm glad we could help. Do you know anyone else facing similar challenges?\"" },
                        { q: "Client wants to cancel?", a: "\"I'm sorry to hear that. Can I understand what's changed? Perhaps there's something we can do.\" Often salvageable." },
                        { q: "When to upsell existing clients?", a: "After 30-60 days of positive results. Lead with value: \"Based on your success with X, have you considered Y?\"" }
                      ].map((item, i) => (
                        <div key={i} className="p-3 rounded bg-muted/30">
                          <p className="font-medium text-sm text-primary mb-1">Q: {item.q}</p>
                          <p className="text-xs text-muted-foreground">A: {item.a}</p>
                ...
                <TabsContent value="notes" className="space-y-4">
                  <div className="p-4 rounded-lg bg-background/50 border">
                    <h4 className="font-semibold mb-3 flex items-center gap-2">
                      ...
                      Guide Structure Logic
                    </h4>
                    <p className="text-sm text-muted-foreground mb-3">This guide is organized to support your entire sales journey:</p>
                    <div className="space-y-2">
                      {[
                        { tab: "Stages", why: "Understand the flow - where you are and where to go next" },
                        { tab: "Assessment", why: "Qualify leads properly - BANT & pain discovery" },
                        { tab: "Personality", why: "Adapt your style - DISC types for personalization" },
                        { tab: "Objections", why: "Handle resistance - LAER framework & common responses" },
                        { tab: "Closing", why: "Seal the deal - 6 techniques & buying signals" },
                        { tab: "Prep", why: "Be ready - checklists & templates for before/after calls" },
                        { tab: "FAQs", why: "Quick answers - scenario-specific guidance" },
                        { tab: "Notes", why: "Meta information - how to use this guide effectively" }
                      ].map((item, i) => (
                        <div key={i} className="flex items-start gap-3 p-2 rounded bg-muted/30">
                          <Badge variant="outline" className="shrink-0 text-xs">{item.tab}</Badge>
                  ...
                  <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                    <h4 className="font-semibold mb-2">How to Use This Guide</h4>
                    <ul className="text-sm text-muted-foreground space-y-2">
                      <li>• <strong>Before calls:</strong> Review Prep tab, refresh on Stages</li>
                      <li>• <strong>During calls:</strong> Keep Objections tab open for quick reference</li>
                      <li>• <strong>After calls:</strong> Reflect using Assessment criteria</li>
                      <li>• <strong>Weekly:</strong> Deep-dive one tab for mastery</li>
                      <li>• <strong>Monthly:</strong> Complete the Training Academy levels</li>
                    </ul>
                  </div>
                  <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                    <h4 className="font-semibold mb-2 text-amber-600">Remember</h4>
                    <p className="text-sm text-muted-foreground">
                      This guide is a reference, not a script. The best salespeople internalize frameworks 
                      and then adapt naturally to each conversation. Practice until these responses become 
                      second nature, then add your personal touch.
                    </p>
                  </div>
                </TabsContent>
              </Tabs>
