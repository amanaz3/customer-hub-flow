...
import { UserCheck, ArrowLeft, Settings2, ListChecks, CalendarClock, Layers } from "lucide-react";
...
export default function Configure1Leads() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-6">
        <Button
          variant="ghost"
          onClick={() => navigate('/configure-1/sales-marketing')}
          className="mb-4"
        >
        ...
        <p className="text-muted-foreground mt-2">
          Manage lead settings and automation
        </p>
      </div>
