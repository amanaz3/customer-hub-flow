      ...
      <div className="grid gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure the test notification parameters</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Customize the test data for the notification</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Alert variant={results.inAppSent ? "default" : "destructive"}>
                ...
                <AlertDescription>
                  In-App Notification: {results.inAppSent ? "Sent Successfully" : "Failed"}
                </AlertDescription>
              </Alert>
              ...
              <Alert variant={results.emailSent ? "default" : "destructive"}>
                ...
                <AlertDescription>
                  Email Notification: {results.emailSent ? "Sent Successfully" : "Failed"}
                </AlertDescription>
              </Alert>
              ...
              {results.inAppSent && (
                <div className="text-sm text-muted-foreground pt-2">
                  Check the notification dropdown (bell icon) in the top navigation to see the in-app notification.
                </div>
              )}
            </CardContent>
          </Card>
