...
export const CustomerEventsSidebar: React.FC<CustomerEventsSidebarProps> = ({ 
  ...
  return (
    <div className={cn(
      "fixed right-0 top-16 h-[calc(100vh-4rem)] bg-card border-l shadow-lg transition-all duration-300 z-[100000] flex flex-col",
      isCollapsed ? "w-12" : "w-80"
    )}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden min-h-0">
        ...
        <TabsContent value="events" className="flex-1 overflow-hidden mt-0 data-[state=active]:flex data-[state=active]:flex-col">
