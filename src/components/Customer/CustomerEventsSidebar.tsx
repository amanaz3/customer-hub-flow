...
export const CustomerEventsSidebar: React.FC<CustomerEventsSidebarProps> = ({ 
  ...
  if (customerLoading) {
    return (
      <div className={cn(
        "fixed left-0 top-0 h-screen bg-card border-r shadow-lg transition-all duration-300 z-[100000]",
  ...
  return (
    <div className={cn(
      "fixed left-0 top-0 h-screen bg-card border-r shadow-lg transition-all duration-300 z-[100000] overflow-y-auto",
      isCollapsed ? "w-12" : "w-80"
    )}>
