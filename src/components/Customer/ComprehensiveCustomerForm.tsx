  ...
  return (
    <div className="space-y-6 relative max-w-5xl mx-auto">
            ...
            <div className="flex-1 relative px-2" style={{ maxWidth: '50px' }}>
              <div className="relative h-1 flex items-center">
                <div className={cn(
                  ...
                  {(currentStage === 'preview' || currentStage === 'documents') && (
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent animate-[slide-in-right_1.5s_ease-in-out_infinite]" />
                  )}
                </div>
                <div className={cn(
      ...
      <Card className="w-full overflow-visible mt-3 relative z-10">
        ...
        <div className="sticky top-[140px] z-50 isolate bg-background -mx-6 px-6 pb-2 border-b shadow-md">
          ...
          <div className="space-y-4 pt-2">
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              <Accordion type="multiple" value={accordionValue} onValueChange={setAccordionValue} className="space-y-4">
                {/* Basic Information */}
                <AccordionItem value="basic" className="border rounded-lg bg-background shadow-sm sticky top-[260px] z-30" data-section-id="basic">
            ...
            <AccordionItem value="lead" className="border rounded-lg bg-background shadow-sm sticky top-[260px] z-30" data-section-id="lead">
                  <AccordionTrigger className="px-4 hover:no-underline justify-start gap-2 border-b">
        ...
        <AccordionItem value="service" className="border rounded-lg bg-background shadow-sm sticky top-[260px] z-30" data-section-id="service">
              <AccordionTrigger className="px-4 hover:no-underline justify-start gap-2 border-b">
        ...
        >
              ...
              {hasTaxRegistration && (
                <AccordionItem value="tax-registration" className="border rounded-lg bg-background shadow-sm sticky top-[260px] z-30">
              ...
              {hasTaxFiling && (
                <AccordionItem value="tax-filing" className="border rounded-lg bg-background shadow-sm sticky top-[260px] z-30">
                  <AccordionTrigger className="px-4 hover:no-underline">
