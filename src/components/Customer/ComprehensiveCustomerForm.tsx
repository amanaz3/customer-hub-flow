...
const ComprehensiveCustomerForm: React.FC<ComprehensiveCustomerFormProps> = ({
  ...
  return (
    <div className="space-y-6 relative max-w-5xl mx-auto px-4 py-6">
      ...
      <Card ref={stageRef} className="sticky top-0 z-50 border shadow-2xl mb-6 overflow-hidden bg-background backdrop-blur-sm">
      ...
      <Card className="w-full overflow-hidden mb-8 relative z-10 border-0 shadow-2xl rounded-2xl bg-background">
        ...
        <div ref={stickyNavRef} className="sticky z-50 isolate bg-background -mx-6 px-6 pb-2 border-b shadow-md" style={{ top: stageHeight + stickyGap }}>
