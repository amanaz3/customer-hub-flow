...
const ComprehensiveCustomerForm: React.FC<ComprehensiveCustomerFormProps> = ({
  ...
  return (
    <div className="relative max-w-5xl mx-auto px-4 pb-6">
      ...
      <Card ref={stageRef} className="sticky top-0 z-[100] border border-b-0 border-border/80 shadow-elegant ring-1 ring-border/50 overflow-hidden bg-background/95 backdrop-blur-md mb-0 rounded-b-none">
