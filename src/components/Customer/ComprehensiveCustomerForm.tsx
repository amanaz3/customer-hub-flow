...
const ComprehensiveCustomerForm: React.FC<ComprehensiveCustomerFormProps> = ({
  ...
  return (
    <div className="relative max-w-5xl mx-auto px-4 pb-6">
      ...
      <Card ref={stageRef} className="sticky top-14 sm:top-16 z-[100] border border-b-2 border-border shadow-elegant ring-1 ring-border/50 overflow-hidden bg-gradient-to-b from-primary/[0.02] to-background/95 backdrop-blur-md mb-0 rounded-b-none">
