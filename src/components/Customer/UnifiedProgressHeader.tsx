...
export const UnifiedProgressHeader = ({
  ...
  return (
    <div className="sticky top-0 z-[120] bg-background shadow-md border-b border-border isolate relative" style={{ contain: 'paint', willChange: 'transform', transform: 'translateZ(0)' }}>
