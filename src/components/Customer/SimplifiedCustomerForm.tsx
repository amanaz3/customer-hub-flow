...
const SimplifiedCustomerForm: React.FC<SimplifiedCustomerFormProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      {/* Right Sidebar - Process Summary (Fixed Position) - Hidden when Customer Events Sidebar is expanded */}
      {(!companyMode || !selectedCustomerId || customerEventsSidebarCollapsed) && (
