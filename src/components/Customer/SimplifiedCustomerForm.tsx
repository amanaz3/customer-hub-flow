    ...
    <div className="w-full relative">
      ...
      <Form {...form}>
          ...
          >
            ...
            <Card 
              className="border-x border-b border-t-0 border-border bg-white shadow-lg hover:shadow-xl transition-all duration-300 ease-out rounded-none overflow-visible relative"
            >
