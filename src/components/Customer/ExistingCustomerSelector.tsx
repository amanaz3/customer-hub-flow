    ...
    <div className="space-y-4 relative z-[99999]">
      <div className="relative">
        ...
        {hasQuery && filteredCustomers.length > 0 && (
          <div className="absolute z-[999999] w-full bottom-full mb-2 border border-slate-200/60 rounded-xl shadow-xl bg-white/95 backdrop-blur-xl">
        ...
        {hasQuery && filteredCustomers.length === 0 && !loading && (
          <div className="absolute z-[999999] w-full bottom-full mb-2 p-4 border rounded-lg shadow-2xl bg-popover backdrop-blur-sm text-center text-sm text-muted-foreground">
        ...
        {loading && hasQuery && (
          <div className="absolute z-[999999] w-full bottom-full mb-2 p-6 border rounded-lg shadow-2xl bg-popover backdrop-blur-sm">
