        ...
        <PopoverTrigger asChild>
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-12 h-12 text-base font-medium bg-white border-slate-200 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none"
            />
            {loading && hasQuery && (
