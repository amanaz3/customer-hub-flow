        ...
        <TabsList className="grid w-full grid-cols-2 h-auto bg-gradient-to-br from-muted/40 via-muted/60 to-muted/40 backdrop-blur-sm border border-border/50 rounded-lg p-1 shadow-sm">
          {value === 'existing' ? (
            <>
              <TabsTrigger 
                value="existing" 
                className="relative flex items-center justify-center gap-1.5 sm:gap-2 py-2 px-2 sm:px-3 h-9 sm:h-10 rounded-md transition-all duration-300 data-[state=active]:bg-gradient-to-br data-[state=active]:from-success data-[state=active]:to-success/90 data-[state=active]:text-success-foreground data-[state=active]:shadow-lg data-[state=active]:shadow-success/20 data-[state=active]:scale-[1.02] data-[state=inactive]:opacity-50 hover:bg-background/60 group"
              >
